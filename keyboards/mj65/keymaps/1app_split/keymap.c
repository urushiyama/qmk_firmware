 ...
 * |-----.--'.--'-.-'--.'---'-.-'---'.--'-.-'--.'--.'--.'--.---|
 * |Caps |Opt| Cmd|  EN| Space|KP_Ent|JP  |Cmd |Opt|Ctr|Opt| Fn|
 * `-----'---'----'----'------'------'----'----'---'---'---'---'
 *
 * - Shift Layer
 *
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT_1APP_SPLIT( /* Base */ \
    ...
    KC_CAPS,    KC_LALT,  KC_LCMD,  JP_MEISU, KC_SPACE, KC_PENT,  JP_MKANA, KC_RGUI,  KC_RALT,  KC_RCTRL, KC_APP,   MO(FN_MO)
  ),
  [FN_MO] = LAYOUT_1APP_SPLIT( /* Function Layer */ \
    ...
    _______,    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  MO(FN_MO)
  ),
    [FN_LO] = LAYOUT_1APP_SPLIT( /* Function Layer (Locked) */ \
    KC_SLEP,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,       KC_F12,     KC_F13,   KC_EJCT, \
    ...
    XXXXXXX,    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  TG(FN_LO)
  ),
};
